...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-checkpoints/audio_primary_v6_murmur_aux.pth}"
OUTPUT_DIR="${OUTPUT_DIR:-results/audio_primary_v6_murmur_aux}"
...
python src/train_audio_primary.py \
  ...
  --model-type "audio_primary_v6_murmur_aux" \

...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-checkpoints/audio_only_baseline_v1.pth}"
OUTPUT_DIR="${OUTPUT_DIR:-results/audio_only_baseline_v1}"
...
python src/train_audio_only_baseline.py \
  --device "${DEVICE}" \
  --epochs "${EPOCHS}" \
  --patience "${PATIENCE}" \

...
POSITION_DROPOUT="${POSITION_DROPOUT:-0.10}"
POSITION_EMBED_DROPOUT="${POSITION_EMBED_DROPOUT:-0.06}"
HARD_NEGATIVE_WEIGHT="${HARD_NEGATIVE_WEIGHT:-0.20}"
HARD_NEGATIVE_MARGIN="${HARD_NEGATIVE_MARGIN:-0.36}"
HARD_NEGATIVE_ABSENT_NORMAL_WEIGHT="${HARD_NEGATIVE_ABSENT_NORMAL_WEIGHT:-1.20}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-checkpoints/audio_primary_v4_8s_hop3.pth}"
OUTPUT_DIR="${OUTPUT_DIR:-results/audio_primary_v4_8s_hop3}"
...
python src/train_audio_primary.py \
  ...
  --model-type "audio_primary_v4_8s_hop3" \
